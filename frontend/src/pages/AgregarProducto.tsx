...
const AgregarProducto = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (countInStock === undefined) {
      console.error("countInStock es undefined");
      return;
    }

    console.log("Valor de countInStock antes de la mutación:", countInStock);
  ...
  if (addProdMutation.isLoading) return <p>Cragando...</p>;

  return (
    <div className="fixed inset-0 overflow-y-auto w-full h-full bg-black bg-opacity-50">
      <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[100px] w-[550px] z-50 rounded-md mb-4">
        <div className="relative p-0 w-full max-w-2xl h-full md:h-auto">
          <div className="relative p-0 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            <div className="flex justify-between items-center pb-0 mb-0 rounded-t border-b sm:mb-5 dark:border-gray-600">
