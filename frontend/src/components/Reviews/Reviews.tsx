    ...
    <>
      {show && (
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 ">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[300px] w-[600px] rounded-md">
            <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
              <div className="relative p-4 bg-white rounded-lg shadow">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className="text-white inline-flex items-center bg-slate-800 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                  >
                    <svg
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm">
            ...
            <p className="mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl">
              Lee lo que nuestros clientes opinan de este producto
            </p>
            <button
              onClick={() => {
                setShow(true);
                ...
                <div>
                  ...
                  <footer className="mb-5 text-sm text-gray-500">
                    <p className="font-semibold">
                      publicado el {r.created.slice(0, 10)}
                    </p>
                  </footer>
                </div>
